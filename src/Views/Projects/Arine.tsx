        ...
        <div className={styles.page}>
            ...
            <div className={styles.contentcontainer}>
                <div className={styles.subsection}>
                    ...
                    <img src="/assets/arine1.png" className={`${styles.image} ${styles['image-dynamic']}`} />
                ...
                <div className={styles.subsection}>
                    ...
                    <div className={styles.sub1section}>
                        <div className={styles.rowcontent}>
                            ...
                            <img src="/assets/arine2.png" className={`${styles.image} ${styles['image-small']}`} />
                        </div> 
                        <div className={styles.rowcontent}>
                            <div className={styles.sub2section}>
                            ...
                            <img src="/assets/arine3.png" className={`${styles.image} ${styles['image-small']}`} />
                        </div>
                        ...
                        <div className={styles.sub2section}>
                            <img src="/assets/arine4.png" className={`${styles.image} ${styles['image-dynamic']}`} />
                            <img src="/assets/arine5.png" className={`${styles.image} ${styles['image-dynamic']}`} />
                        </div>
                ...
                <div className={styles.subsection}>
                    <div className={styles.sub2section}>
                            <h1 className={styles.sh2}>Colors</h1>
                                <div className={styles.rowcontent}>
                                    <img src="/assets/arine6.png" className={`${styles.image} ${styles['image-small']}`} />
                                    <img src="/assets/arine7.png" className={`${styles.image} ${styles['image-small']}`} />
                                </div>
                    </div>
                    <div className={styles.sub2section}>
                            <h1 className={styles.sh2}>Typography</h1>
                                <div className={styles.rowcontent}>
                                    <img src="/assets/arine8.png" className={`${styles.image} ${styles['image-small']}`} />
                                    <img src="/assets/arine9.png" className={`${styles.image} ${styles['image-small']}`} />
                                </div>
                    </div>
                    <img src="/assets/arine10.png" className={`${styles.image} ${styles['image-dynamic']}`} />
                </div>
                ...
                <div className={styles.subsection}>
                    ...
                    <div className={styles.sub1section}> 
                            <div className={styles.sub1section}>
                                ...
                                <img src="./assets/arine12.png" className={`${styles.image} ${styles['image-dynamic']}`} />
                            ...
                            <img src="/assets/arine13.png" className={`${styles.image} ${styles['image-dynamic']}`} />  
                            <img src="/assets/arine14.png" className={`${styles.image} ${styles['image-dynamic']}`} />                        
                            <img src="/assets/arine15.png" className={`${styles.image} ${styles['image-dynamic']}`} />                        
                    </div>
                </div>
            </div>
            </div>
