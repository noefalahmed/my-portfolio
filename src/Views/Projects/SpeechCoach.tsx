    ...
    },
    {
        ...
        <>
            ...
            <div className={styles.subsection}>
                ...
                <p className={styles.p1}>Each character also had a specific voice chosen to carry the emotional range the scenario required, an opening line that set the tone immediately, and hard rules about staying in character no matter what the student said or tried. The ending conditions were just as deliberate. The conversation had a shape, and the character knew when it was over.</p>
